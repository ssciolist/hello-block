  ...
  describe 'when I visit the homepage' do
    describe 'and enter a Denver address in the search bar,' do
      it 'shows me a figure and permit results within one mile' do
        ...
        BuildingPermit.create(date_issued: "2015-04-06 11:38:17", permit_number: "24", address: "123 street", valuation: 770690, fee: 4, owner_name: "JASMINE", contractor_name: "besine", permit_type: permit, latitude: 39.74863, longitude: -104.91841)
        BuildingPermit.create(date_issued: "2015-04-06 11:38:17", permit_number: "324", address: "3123 street", valuation: 0, fee: 34, owner_name: "JASMINE", contractor_name: "besine", permit_type: permit, latitude: 39.7455399339223, longitude: -104.92825913894)
